...
diccionario_clasificado <- diccionario %>%
  mutate(
    modulo = case_when(
      codigo %in% mod_socio ~ "Módulo 1: Socio-Demográfico",
      ...
      codigo %in% mod_influencia ~ "Módulo 4: Influencia social",
      codigo %in% mod_acoso_vbg ~ "Módulo 5: Experiencias de acoso, inseguridad y VBG",
      codigo %in% mod_identidad ~ "Módulo 6: Identidad de género",
