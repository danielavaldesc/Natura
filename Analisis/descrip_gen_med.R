###############################################################################
###############################################################################
## Análisis descriptivo de la encuesta segmentado POR GÉNERO (Medellín)     ##
###############################################################################
###############################################################################
...
# Carpeta de salida
dir.create("Output/Medellin/Output_by_genero", recursive = TRUE, showWarnings = FALSE)
...
cross_tab(
  ...
  tex_path  = "Output/Medellin/Output_by_genero/modo_edad.tex",
  xlsx_path = "Output/Medellin/Output_by_genero/modo_edad.xlsx"
)
...
cross_tab(
  ...
  tex_path  = "Output/Medellin/Output_by_genero/genero_edad.tex",
  xlsx_path = "Output/Medellin/Output_by_genero/genero_edad.xlsx"
)
...
cross_tab(
  ...
  tex_path  = "Output/Medellin/Output_by_genero/modo_estrato.tex",
  xlsx_path = "Output/Medellin/Output_by_genero/modo_estrato.xlsx"
)
...
normalidad <- normality(
  ...
  output_tex  = "Output/Medellin/Output_by_genero/normalidad.tex",
  output_xlsx = "Output/Medellin/Output_by_genero/normalidad.xlsx"
)
...
descriptivas.continuas <- cont_descriptive_gender(
  ...
  output_tex      = "Output/Medellin/Output_by_genero/descriptiva.continuas.tex",
  output_xlsx     = "Output/Medellin/Output_by_genero/descriptiva.continuas.xlsx"
)
...
descriptivas.discretas <- cat_descriptive_gender(
  data       = dataset,
  cat_vars   = cat,
  output_tex  = "Output/Medellin/Output_by_genero/descriptiva.discretas.tex",
  output_xlsx = "Output/Medellin/Output_by_genero/descriptiva.discretas.xlsx"
)
...
kruskal <- kruskal_test(
  ...
  output_tex  = "Output/Medellin/Output_by_genero/Kruskal.tex",
  output_xlsx = "Output/Medellin/Output_by_genero/Kruskal.xlsx"
)
...
chi2 <- chi2_test(
  data       = dataset,
  discretas  = cat,
  output_tex  = "Output/Medellin/Output_by_genero/Chi_2.tex",
  output_xlsx = "Output/Medellin/Output_by_genero/Chi_2.xlsx"
)
...
writexl::write_xlsx(summary_all, "Output/Medellin/Output_by_genero/Summary.xlsx")
