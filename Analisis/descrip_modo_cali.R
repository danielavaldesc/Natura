############################################################################
############################################################################
## Análisis descriptivo de la encuesta según modos de transporte de Cali ##
############################################################################
############################################################################
...
cross_tab(
  ...
  tex_path = "Output/Cali/Output_by_mode/edad_sexo.tex",
  xlsx_path = "Output/Cali/Output_by_mode/edad_sexo.xlsx"
)
...
cross_tab(
  ...
  tex_path = "Output/Cali/Output_by_mode/modo_edad.tex",
  xlsx_path = "Output/Cali/Output_by_mode/modo_edad.xlsx"
)
...
cross_tab(
  ...
  tex_path = "Output/Cali/Output_by_mode/modo_estrato.tex",
  xlsx_path = "Output/Cali/Output_by_mode/modo_estrato.xlsx"
)
...
normalidad <- normality(
  ...
  output_tex = "Output/Cali/Output_by_mode/normalidad.tex",
  output_xlsx = "Output/Cali/Output_by_mode/normalidad.xlsx"
)
...
descriptivas.continuas <- cont_descriptive(dataset,
                                           ...
                                           output_tex = "Output/Cali/Output_by_mode/descriptiva.continuas.tex",
                                           output_xlsx = "Output/Cali/Output_by_mode/descriptiva.continuas.xlsx")
...
descriptivas.discretas = cat_descriptive(data = dataset,
                                         cat_vars = cat,
                                         output_tex = "Output/Cali/Output_by_mode/descriptiva.discretas.tex",
                                         output_xlsx = "Output/Cali/Output_by_mode/descriptiva.discretas.xlsx")
...
kruskal = kruskal_test(data = dataset,
                       ...
                       discretas = c("p17", cat),
                       output_tex = "Output/Cali/Output_by_mode/Kruskal.tex",
                       output_xlsx = "Output/Cali/Output_by_mode/Kruskal.xlsx")
...
chi2 = chi2_test(data = dataset,
                 discretas = c("p17", cat),
                 output_tex = "Output/Cali/Output_by_mode/Chi_2.tex",
                 output_xlsx = "Output/Cali/Output_by_mode/Chi_2.xlsx")
...
writexl::write_xlsx(summary_all, "Output/Cali/Output_by_mode/Summary.xlsx")
