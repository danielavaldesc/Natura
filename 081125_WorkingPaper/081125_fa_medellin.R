...
# Variables para el análisis factorial
vars <- c(
  "id",
  "medio",
  "edad_r2",
...
g1 <- ggplot(plot_df, aes(x = dim, y = variance/100)) +
  ...
  labs(title = "MCA: Varianza explicada por dimension",
       x = "Dimension", y = "%") +
...
ggsave(filename = "figures_wp/medellin/varianza_mca.png", plot = g_comb, height = 12,
       width = 12)
...
writexl::write_xlsx(paran.df, "figures_wp/medellin/paran.xlsx")
...
ggsave(filename = "figures_wp/medellin/mca_var.png", plot = mca_var, height = 12/1.5,
       width = 12/1.5)
...
ggsave("figures_wp/medellin/mca_cor.png", mca_cor_fancy, width = 8.5, height = 7, dpi = 300)
...
ggsave("figures_wp/medellin/mca_contrib_panel.png", plot = panel_contrib,
...
# Guardar
ggsave("figures_wp/medellin/mca_ind_medio.png", mca_ind_medio, width = 8, height = 6, dpi = 300)
...
saveWidget(as_widget(fig), "figures_wp/medellin/mca_ind_medio_3d.html", selfcontained = TRUE)
