##############################################
## MNL Medellín – Especificación final      ##
...
stargazer(mnl.ctrl2_con, type = "html",
          title = "MNL (mnl.ctrl2) – CON comunas",
          single.row = TRUE, na.replace = "",
          out = file.path(out_dir, "mnl_ctrl2_CONcomunas_stargazer.html"))
stargazer(mnl.ctrl2_sin, type = "html",
          title = "MNL (mnl.ctrl2) – SIN comunas",
          single.row = TRUE, na.replace = "",
          out = file.path(out_dir, "mnl_ctrl2_SINcomunas_stargazer.html"))
...
writexl::write_xlsx(
  ...
  path = file.path(out_dir, "mnl_ctrl2_OR_CONySIN.xlsx")
)

cat("\n✅ Resultados guardados en:\n", normalizePath(out_dir), "\n",
    "- mnl_ctrl2_CONcomunas_stargazer.html\n",
    "- mnl_ctrl2_SINcomunas_stargazer.html\n",
    "- mnl_ctrl2_OR_CONySIN.xlsx\n", sep = "")
