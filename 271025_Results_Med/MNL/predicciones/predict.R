############################################################
## Predicción de probabilidades por perfil Medellín       ##
############################################################
...
write_xlsx(tables, path = file.path(out_dir, "predicciones_perfiles_MNL_Med.xlsx"))
message("Listo: ", file.path(out_dir, "predicciones_perfiles_MNL_Med.xlsx"))
